...
# إعداد Hugging Face
# ================================
HF_TOKEN = "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"  # استبدل بالتوكن بتاعك لو عايز
...
# ================================
# Schemas لتنسيق الناتج
# ================================
response_schemas = [
    ResponseSchema(name="full_name", description="The full name of the candidate"),
    ResponseSchema(name="email", description="The email address of the candidate"),
    ResponseSchema(name="education", description="List of education entries, each with degree, institution, and year"),
    ResponseSchema(name="skills", description="List of skills possessed by the candidate"),
    ResponseSchema(name="experience", description="List of work experience entries, each with role, company, and years"),
]
...
def parse_cv_content(cv_text: str):
    """تحليل نص السيرة الذاتية وإرجاع JSON"""
